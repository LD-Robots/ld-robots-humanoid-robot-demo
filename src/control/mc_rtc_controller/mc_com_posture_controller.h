...
struct G1CoMPostureController final : public MCController
{
public:
  G1CoMPostureController(std::shared_ptr<mc_rbdyn::RobotModule> robot_module, double dt, Backend backend);
